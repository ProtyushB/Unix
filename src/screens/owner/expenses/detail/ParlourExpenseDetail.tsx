...
/**
 * Parlour's slots for the Expense Detail screen.
 *
 * A plain function, not a component — there is nothing to render, only data the base uses. Every
 * decision about what differs per module lives in `expenseDetail.modules.ts`, because that file is
 ...
 */
export function parlourExpenseSlots(): ExpenseDetailSlots {
