import { configFor, moduleLabel } from './wastageDetail.modules';
...
describe('module divergence', () => {
  it('is EMPTY for both modules today, and this test is the tripwire', () => {
    // The two controllers are byte-identical apart from their base path. Wastage is the likeliest
    // of the three to grow a pharmacy-only field — a controlled-substance write-off carries
    // obligations a salon's does not — and this is where that lands.
