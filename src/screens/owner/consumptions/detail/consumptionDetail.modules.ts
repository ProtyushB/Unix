...
/**
 * What differs between parlour and pharmacy consumptions.
 *
...
export interface ConsumptionModuleConfig {
  moduleKey: ModuleKey;
...
const PARLOUR: ConsumptionModuleConfig = {
  moduleKey: 'PARLOUR',
  label: 'Parlour',
  extraFields: [],
};

const PHARMACY: ConsumptionModuleConfig = {
  moduleKey: 'PHARMACY',
  label: 'Pharmacy',
  extraFields: [],
};
 ...
 */
export function configFor(moduleKey: string | null | undefined): ConsumptionModuleConfig {
