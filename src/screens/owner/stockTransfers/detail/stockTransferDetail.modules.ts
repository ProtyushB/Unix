...
/**
 * What differs between parlour and pharmacy stock transfers.
 *
...
export interface StockTransferModuleConfig {
  moduleKey: ModuleKey;
...
const PARLOUR: StockTransferModuleConfig = {
  moduleKey: 'PARLOUR',
  label: 'Parlour',
  extraFields: [],
};

const PHARMACY: StockTransferModuleConfig = {
  moduleKey: 'PHARMACY',
  label: 'Pharmacy',
  extraFields: [],
};
 ...
 */
export function configFor(moduleKey: string | null | undefined): StockTransferModuleConfig {
