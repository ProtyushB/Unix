...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        icon: CalendarClock,
        label: 'Service Plans',
        route: { tab: 'ServicePlans' },
        tabKey: 'SERVICE_PLANS',
      },
    ],
  },
  {
    ...
    items: [
      ...
      // Route names are plural, the backend keys are singular — mind the gap.
      {
        icon: Beaker,
        label: 'Consumptions',
        route: { tab: 'Consumptions' },
        tabKey: 'CONSUMPTION',
      },
      {
        icon: ArrowLeftRight,
        label: 'Stock Transfers',
        route: { tab: 'StockTransfers' },
  ...
  },
  {
    ...
    label: 'Contacts',
    groupIcon: User,
    items: [{ icon: User, label: 'Customers', route: { tab: 'Customers' }, tabKey: 'CUSTOMERS' }],
  },
  {
    id: 'team',
    label: 'Team',
    groupIcon: Users,
    items: [{ icon: Users, label: 'Employees', route: { tab: 'Employees' }, tabKey: 'EMPLOYEES' }],
  },
  {
    id: 'post-sale',
    label: 'Post-sale',
    ...
    items: [
      {
        ...
        route: { tab: 'WarrantyClaims' },
        tabKey: 'WARRANTY_CLAIMS',
      },
  ...
  },
  {
    ...
    label: 'Analytics',
    groupIcon: BarChart3,
    items: [{ icon: BarChart3, label: 'Reports', route: { tab: 'Reports' }, tabKey: 'REPORTS' }],
  },
  {
    id: 'account',
    label: 'Account',
    ...
    items: [{ icon: User, label: 'Profile', route: { tab: 'Account' } }],
  },
];
 ...
 */
export function filterNavGroupsByTabs(groups: NavGroup[], tabs?: TabMap | null): NavGroup[] {
